...
from zefron.modules.nightmode import button_row
from zefron import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from zefron.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./zefron/resources/fonts/*")
